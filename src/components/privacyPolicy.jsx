...
const PrivacyPolicy = () => {
  return (
    <>
      <div className="mx-auto p-8 max-w-screen-xl flex-col text-white justify-start shadow-lg mt-20">
        <div className="flex items-start mb-4">
          <img src="privacy.png" alt="privacy" className="h-[72px]" />
        </div>
        ...
        <p className="mb-4">
          We implement security measures to protect your data, but please be aware that no method of transmission over the internet is 100% secure.
        </p>
