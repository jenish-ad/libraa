...
export default function Navbar() {
  ...
  <div className=" max-w-screen-3xl mx-auto px-4 py-3 flex items-center justify-start">
    ...
    <div className="hidden md:flex mx-8 space-x-6">
        <Link to="/about" className="text-gray-900 hover:text-blue-700 dark:text-white dark:hover:text-yellow-500">Home</Link>
        <Link to="/" className="text-gray-900 hover:text-blue-700 dark:text-white dark:hover:text-yellow-500">About</Link>
        ...
        <Link to="/" className="text-gray-900 hover:text-blue-700 dark:text-white dark:hover:text-yellow-500">Contact</Link>
    </div>
